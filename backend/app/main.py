...
from api.assess_frame    import router as assess_frame_router   # ← NEW
from api.learner_state   import router as learner_state_router  # ← NEW
...
app.include_router(assess_frame_router,     prefix="/api")   # ← NEW
app.include_router(learner_state_router,    prefix="/api")   # ← NEW
app.include_router(reports_router,          prefix="/api")   # ← NEW

@app.get("/")
def root():
    return {"message": "Sign Language Platform API is running", "version": "0.2.0"}